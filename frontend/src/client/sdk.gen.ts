...
export class QuestionsService {
    ...
    public static readQuestionsForReview<ThrowOnError extends boolean = true>(options?: Options<questionsReadQuestionsForReviewData, ThrowOnError>) {
        return (options?.client ?? client).get<questionsReadQuestionsForReviewResponses, questionsReadQuestionsForReviewErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
